...
namespace Il2CppDumper
{
    internal static class Il2CppDummyDll
    {
        ...
        public static AssemblyDefinition Create()
        {
            ...
            addressAttribute.Fields.Add(new FieldDefinition("RVA", (FieldAttributes)6, stringTypeReference));
            addressAttribute.Fields.Add(new FieldDefinition("Offset", (FieldAttributes)6, stringTypeReference));
            ...
            fieldOffsetAttribute.Fields.Add(new FieldDefinition("Offset", (FieldAttributes)6, stringTypeReference));
            ...
            attributeAttribute.Fields.Add(new FieldDefinition("Name", (FieldAttributes)6, stringTypeReference));
            attributeAttribute.Fields.Add(new FieldDefinition("RVA", (FieldAttributes)6, stringTypeReference));
            attributeAttribute.Fields.Add(new FieldDefinition("Offset", (FieldAttributes)6, stringTypeReference));
